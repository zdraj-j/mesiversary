...
const CONFIG = {
  ...
  actividades: [
    ...
    {
      hh: 18, mm: 0,
      tag: "18:00 · esta actividad es abierta",
      titleTop: "Aquí ya deberíamos", titleEm: "estar haciendo algo",
      label: "(no sé si era patolandia al fin, si no, ya debería haber cambiado este texto",
      icon: "bird", heroIcon: "bird",
      title: "Patoland",
      desc: "Espero esto me salga bien",
      barLabel: "",
    },
     {
      hh: 21, mm: 0,
