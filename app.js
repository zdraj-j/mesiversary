  ...
  actividades: [
    {
      ...
      titleTop: "Diez meses", titleEm: "con mi amorcito",
      label: "Falta para nuestro decimesiversario",
      icon: "heart", heroIcon: "vector-polygon",
      title: "¡Felices 10 meses, mi amor!",
      desc: "Hoy cumplimos diez meses juntos y lo siento mucho porque no tengo esto tan preparado pero hoy todo será sorpresa para los dos. Mi amas vin",
      barLabel: "Próximo",
    },
    {
      hh: 9, mm: 0,
      tag: "09:00 am · recordatorio",
      titleTop: "Es un buen momento", titleEm: "para recordarte",
      label: "(...)",
      icon: "pen-tool", heroIcon: "book-heart",
      title: "que te amo",
      desc: "y me encanta estar contigo",
      barLabel: "Una notica",
    },
    {
      hh: 12, mm: 00,
      tag: "13:30 · Almuercito con esa gentucha",
      titleTop: "Asuntos", titleEm: "de fuerza mayor",
      label: "no sé esto en qué parte se muestra",
      icon: "sandwich", heroIcon: "utensils",
      title: "¡Es hora del comer(nos)!",
      desc: "Ni modo, toca ir a comer con gente fea, pero tú haces que todo sea más bonito para mí",
      barLabel: "Lunch time",
    },
    {
      hh: 16, mm: 45,
      tag: "15:40 · Baoku",
      titleTop: "Vamo a cená", titleEm: "comida china",
      label: "sigo sin saber esto dónde se muestra",
      icon: "utensils", heroIcon: "rose",
      title: "Porque tus deseos son órdenes",
      desc: "Vamos a comer cosas que ojalá estén ricas, sino pues el postre sé que lo estará",
      barLabel: "Libres somos",
    },
     {
      hh: 21, mm: 0,
      tag: "21:00 · Cierre",
      titleTop: "Decimesiversario", titleEm: "y ya casi llega el aniversario",
      label: "en algún lado ha de verse, me imagino",
      icon: "heart", heroIcon: "heart-handshake",
      title: "Hora de máster chef",
      desc: "a ver si sacan a Pautips. PD. I love u",
      barLabel: "(...)",
    },
  ],
